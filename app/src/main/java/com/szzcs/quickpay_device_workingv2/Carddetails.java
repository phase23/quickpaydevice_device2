...
// %B4100750001509794^JNO-BAPTISTE/PHILMON.^2402101926200010000000598000000?;4100750001509794=24021019262059800100?
        ...
        emailpart = (EditText)findViewById(R.id.emailpart);
        ...
        isother.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if (isChecked) {
                    ...
                    thisemailpart = emailpart.getText().toString();

                    thisfullemail.setText(thisemailpart);
                    emailpart.setVisibility(View.VISIBLE);
        ...
        dochargecard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String checkemail = thisfullemail.getText().toString();
                ...
                if(!connected) {
                    ...
                    try {
                        ...
                        Log.i("[print]", "https://quickpay.ai/api_chargecard.php?deviceid=" + thismydevice + "&ccnumber=" + getcardno + "&cvv=" + thiscvv + "&charge=" + thisamount + "&expr=" + getexpiry + "&ccname=" + fname + ' ' + lname + "&tip=" + tip + "&getemail="+checkemail) ;
                        doGetRequest("https://quickpay.ai/api_chargecard.php?deviceid=" + thismydevice + "&ccnumber=" + getcardno + "&cvv=" + thiscvv + "&charge=" + thisamount + "&expr=" + getexpiry + "&ccname=" + fname + ' ' + lname + "&tip=" + tip + "&getemail="+checkemail);
                    } catch (IOException e) {
                        e.printStackTrace();
                    }
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if(postaction.equals("")){
                                    ...
                                    emailpart.setVisibility(View.INVISIBLE);
